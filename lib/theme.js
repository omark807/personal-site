...
// Link text uses a darker teal in light mode so it clears WCAG AA (4.5:1)
// on the cream background; dark mode keeps the bright teal (already high contrast).
const linkColor = props => mode('brand.700', 'brand.muted')(props)
const linkHoverColor = props => mode('brand.800', 'brand.200')(props)
