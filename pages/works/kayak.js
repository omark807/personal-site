...
const Project = () => (
    <Layout>
        <Container>
            ...
            <br></br>
            <Heading as="h2">Findings and Recommendation</Heading>
         
            <br>
            </br>

            <Heading as="h3" size="md">Summary Results</Heading>
            ...
            <Heading as="h3" size="md">Key Findings</Heading>
            <br>
            </br>
            <Heading as="h4" size="sm"><u>Finding 1</u></Heading>
            <P>
                User did not notice the filter bar at the top, and thus was not using it efficiently to find flights
            </P>

            <Heading as="h5" size="sm">Severity: 3</Heading>
            <Link target="_blank" href="https://drive.google.com/file/d/1cMy4ZEcHS5dXNxAqZQWuZ5f3ZNW56n4F/view?usp=sharing" rel="noopener noreferrer" aria-label="View interface component in question (opens in new tab)">
                        Interface Component in Question
            </Link> <ExternalLinkIcon aria-hidden="true" />
            <Heading as="h5" size="sm">Recommendation: </Heading>
            <P>
            ...
            <Heading as="h4" size="sm"><u>Finding 2</u></Heading>
            <P>
                Cannot efficiently adjust duration and price sliders
            </P>

            <Heading as="h5" size="sm">Severity: 3</Heading>
            <Link target="_blank" href="https://drive.google.com/file/d/1VAej-T83fwJdhVO9K_t9waV9OV6yzwql/view?usp=sharing" rel="noopener noreferrer" aria-label="View interface component in question (opens in new tab)">
                        Interface Component in Question
            </Link> <ExternalLinkIcon aria-hidden="true" />           
            <Heading as="h5" size="sm">Recommendation: </Heading>
            <P>
            ...
            <Heading as="h4" size="sm"><u>Finding 3</u></Heading>
            <P>
            ...
            <Heading as="h5" size="sm">Severity: 2</Heading>
            <Link target="_blank" href="https://drive.google.com/file/d/1JkV1e5lZlH_ObvTgE_dEJD8oMcPQI11U/view?usp=sharing" rel="noopener noreferrer" aria-label="View interface component in question (opens in new tab)">
                        Interface Component in Question
            </Link> <ExternalLinkIcon aria-hidden="true" />           
            <Heading as="h5" size="sm">Recommendation: </Heading>
            <P>
            ...
            <List>
                <ListItem>
                    <Meta>Link</Meta>
                    <Link target="_blank" href="https://docs.google.com/document/d/1ZwPsz2A0BAL0JUKBZRmvMIeZHLXvyGlYWwNeeh17I0o/edit?usp=sharing" rel="noopener noreferrer" aria-label="View Kayak project document (opens in new tab)">
                        Document
                    </Link> <ExternalLinkIcon aria-hidden="true" />
                </ListItem>
                {/* <ListItem>
